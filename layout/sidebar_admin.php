    ...
    <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="../<?php echo $accnt_dir; ?>reports/risk-reports">Risk Report</a></li>
                    <li><a class="nav-link" href="../<?php echo $accnt_dir; ?>reports/compliance-report">Compliance Report</a></li>
                    ...
                    <li><a class="nav-link" href="../<?php echo $accnt_dir; ?>reports/business-impact-analysis-report">BIA Report</a></li>
