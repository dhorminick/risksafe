...
<head>
  ...
  <title>RiskSafe Tickets | <?php echo $siteEndTitle; ?></title>
                            ...
                            <div class="card">
                              ...
                              <div class="card-body">
                                ...
                                <div class="support-ticket media pb-1 mb-3">
                                  ...
                                  <a href="tickets?id=<?php echo strtolower($items['ticket_id']); ?>" style="text-decoration: none !important;">
