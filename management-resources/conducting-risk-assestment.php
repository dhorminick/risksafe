...
<html lang="en">
  <head>
    ...
    <title>Conducting Risk Assesment | Resources</title>
  ...
  <body class="flex flex-col gap-[30px]">
    ...
    >
      <div class="text-[13px] text-gray-500">
        ...
        <span class="text-gray-500">Control Self Assessment</span>
      </div>
                ...
                <div class="p-6 sm:w-1/2">
                  ...
                  <div class="card-body text-gray-700 leading-relaxed">
                    ...
                    <p class="mb-4">
                      ...
                      is designed to focus on processes and issues that are
                      important to a business or organisation.
                    </p>
                    <p class="mb-4">
                    ...
                    <p class="mb-4">
                      Control measures that have been implemented must be
                      reviewed, and if necessary, revised to make sure they work
                      as planned.
                    </p>
                    <p class="mb-4">
                      There are certain situations where you must review your
                    ...
                    <ul class="list-disc pl-6 mb-4">
                      <li class="mb-2">
                        ...
                        the risk e.g. when an incident occurs
                      </li>
                      <li class="mb-2">
                        Before a change at the workplace that is likely to give
                        rise to a new or different health and safety risk that
