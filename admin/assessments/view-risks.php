<?php
    ...
    if (isset($_GET['id']) && isset($_GET['id']) !== "") {
        ...
        $toDisplay = true;
        $CheckIfAssessmentDetailsExist = "SELECT * FROM as_assessment_new WHERE risk_id = '$ri_id' AND c_id = '8UT8QR55FR'";
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="r_desc">
                                        ...
                                        ?>
                                        <li><?php echo ucfirst(__getIncident('8UT8QR55FR', $treatment, $con)); ?></li>
                                        <?php } ?>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="r_desc">
                                    ...
                                    echo '<ul>';
                                        ...
                                        foreach($treatments as $treatment){
                                    ?>
                                    <li><?php echo ucfirst(getAssessmentTreatment($info['treatment_type'], $treatment, '8UT8QR55FR', $con)); ?></li>
