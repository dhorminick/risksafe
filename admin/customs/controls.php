        ...
        <div class="main-content">
            ...
            <div class="section-body">
                    ...
                    <form method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary btn-icon icon-left header-a" href="edit-control?id=<?php echo $info["control_id"]; ?>"><i class="fas fa-arrow-left"></i> Edit Control</a>
                            </div>
                            <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            $list_one = listCustomControls(0, 20, $company_id, $con);
