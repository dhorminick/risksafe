<?php
    ...
    if (isset($_POST["export-report"])) {
        ...
        if($startDate > $smallestNumber__1){
            ...
            $query="SELECT * FROM policyfields WHERE c_id = '$company_id' AND PolicyEffectiveDate BETWEEN CAST('$startDate' as datetime) AND CAST('$endDate' as datetime) ORDER BY id DESC";
            ...
            <div class="section-body">
                <div class='card'>
                    <div class="card-header">
                        ...
                        <a style='display:none;' class="btn btn-primary btn-icon icon-left header-a" href="../compliances/new-policy"><i class="fas fa-plus"></i> New Policy</a>
                    </div>
                    <div class='card-body'>
        					...
        					<div class="form-group">
        					    <div class="card-bod">
                    		        ...
                    		        <div class='form-group col-lg-12 col-12' style='font-weight:400;'>
                    		            <strong>NOTE:</strong> Earliest Registered Policy - <?php echo $smallestNumber__1; ?> and Most Recent Registered Policy - <?php echo $largestNumber__1; ?>
                    		        </div>
                    		        </div>
                                    <div style='width:100%;text-align:center;margin-top:10px;text-align:right;'>
                                        <button type="submit" class="btn btn-lg btn-primary btn-icon icon-left" name='export-report'><i class='fas fa-file-download'></i> Export Policy Report</button>
                					</div>
                                    <?php } ?>
                					</div>
        				</form>
