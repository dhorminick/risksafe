<?php
    ...
    if (isset($_POST['delete-data'])){
        ...
        if (!$id || $id == null || $id == '' || !$type || $type == null || $type == '') {
            ...
            $query="DELETE FROM as_monitoring WHERE m_id = '$id' AND c_id = '$company_id'";
            $dataDeleted = $con->query($query);
                    
            if ($dataDeleted) {
                array_push($message, 'Monitoring Deleted Successfully!!');
            }else{
...
<head>
  ...
  <title>Controls | <?php echo $siteEndTitle ?></title>
            ...
            <div class="section-body">
                    ...
                    <form method="post">
                        <div class="card-body">
                            ...
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary btn-icon icon-left header-a" href="all-monitoring"><i class="fas fa-arrow-left"></i> Back</a>
                            </div>
                            <div class="card-body">
                                <div class="row section-rows customs">
                                    <div class="user-description col-12 col-lg-4">
                                        <label>Control Number:</label>
                                        <div class="description-text"><?php echo $info['number']; ?></div>
                                    </div>
                                    <div class="user-description col-12 col-lg-8">
                                        <label>Control Title :</label>
                                        <div class="description-text"><?php echo ucfirst($info['title']); ?></div>
                                    </div>
                                    ...
                                    <div class="user-description col-12 col-lg-4">
                                        <label>Control:</label>
                                        <div class="description-text"><?php echo ucfirst($info['keys']); ?></div>
                                    </div>
                                    <div class="user-description col-12 col-lg-4">
                                        <label>Control Type:</label>
                                        <div class="description-text"><?php echo ucfirst($info['type']); ?></div>
                                    </div>
                                    <div class="user-description col-12 col-lg-4">
                                        <label>Control Nature:</label>
                                        <div class="description-text"><?php echo ucfirst($info['nature']); ?></div>
                                    </div>
                                    <div class="user-description col-12 col-lg-4">
                                        <label>Control Testing Techniques:</label>
                                        <div class="description-text"><?php echo ucfirst($info['techniques']); ?></div>
                                    </div>
                                    <div class="user-description col-12 col-lg-8">
                                        <label>Control Owner:</label>
                                        <div class="description-text"><?php echo ucfirst($info['owner']); ?></div>
                                    </div>
                                    ...
                                    <div class="user-description col-12">
                                        ...
                                        <div class="description-text"><?php echo nl2br(html_entity_decode($info['outcome'])); ?></div>
                                    </div>
                                    <div class="user-description col-12 col-lg-8">
                                        <label>Audit Outcome:</label>
                                        <div class="description-text"><?php echo nl2br(html_entity_decode($info['audit_outcome'])); ?></div>
                                    </div>
                                    <div class="user-description col-12 col-lg-4">
                                        <label>Next Audit:</label>
                                        <div class="description-text"><?php echo $info['next']; ?></div>
                                    </div>
                ...
                <div class="card">
                    <div style="width:100%;min-height:400px;display:flex;justify-content:center;align-items:center;">
                        <div style="text-align: center;"> 
                             ...
                             <p><a href="new-monitoring" class="btn btn-primary btn-icon icon-left mt-2"><i class="fas fa-plus"></i> Register New Control</a></p></div>
                     </div>
                </div>
                <?php } ?>
                <?php }else{ ?>
                <div class="card">
                    <div class="card-header" style="margin-top: 20px;">
                        <h3 class="d-inline">Monitorings</h3>
                        <a class="btn btn-primary btn-icon icon-left header-a" href="new-monitoring"><i class="fas fa-plus"></i> New Control</a>
                    </div>
                    
                    <div class="card-body">
                        <?php
                            $CheckIfCustomExist = "SELECT * FROM as_monitoring WHERE c_id = '$company_id' ORDER BY id desc";
                        ...
                        <table class="table table-striped table-bordered table-hover" id="table">
                            ...
                            <?php 
                                ...
                                $viewLink = '?id='.$item["m_id"].'" data-toggle="tooltip" title="View Monitoring" data-placement="right"';
                                $editLink = 'edit-monitoring?id='.$item["m_id"].'" data-toggle="tooltip" title="Edit Monitoring" data-placement="right"';
                                $deleteLink = 'javascript:void(0);" class="delete action-icons btn btn-danger btn-action mr-1" data-toggle="modal" data-target="#deleteModal" data-type="control" data-id="'.$item["m_id"];
                            ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                        ...
                        <div style="width:100%;min-height:400px;display:flex;justify-content:center;align-items:center;">
                            <div style="text-align: center;"> 
                                <h3>Empty Data!!</h3>
                                No Control Registered Yet,
                                <p><a href="new-monitoring" class="btn btn-primary btn-icon icon-left mt-2"><i class="fas fa-plus"></i> Create New Control</a></p>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
