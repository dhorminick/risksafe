...
if (isset($_REQUEST["response"]) and $_REQUEST["response"]=="true") {
	$msg="New antimoney created successfully.";
}

if (isset($_REQUEST["response"]) and $_REQUEST["response"]=="err") {
	$msg="Error creating new risk antimoney, please try again.";
}
...
<div class="row">
  ...
  <div class="col-lg-9 col-md-12">
    <h1 class="page-header">New Anti Money Laundering</h1>
		      ...
		      <div class="alert alert-info" id="notify" <?php if (!isset($msg)) { ?>style="display: none;"<?php } ?>>
		        ...
		        <h3 class="subtitle">Choose a Type of Risk Assessment</h3>
		         ...
		         <div class="form-group">
		          ...
		          <div class="form-group">
		          		<button type="submit" class="btn btn-md btn-info" id="btn_save">Create a AML Risk Assessment</button>
