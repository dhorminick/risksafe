...
<div class="row">
  ...
  <div class="col-lg-9 col-md-12">
    	<h1 class="page-header">Insurances</h1>
		  ...
		  <div class="">
		    <div class="panel panel-default">
		      <div class="panel-body">
		          ...
		          <button type="button" class="btn btn-md btn-info pull-right" id="btn_add">+ New Insurance</button>
		          </div>
...
$(document).ready(function(e) {
   ...
   var table = $('#table').dataTable( {
        ...
        "ajax": "../controller/insurence.php?action=list"
    } );

  $("#btn_add").click(function(e) {
	  $(location).attr("href","../view/insurence.php?action=add");
  });	
}); 
...
function del(id) {
	BootstrapDialog.show({
		...
		buttons: [{
			...
			cssClass:'btn-danger',
			action: function(dialogItself){
				res = $.ajax({type: "GET", url: "../controller/insurence.php?action=delete&id="+id, async: false})	
