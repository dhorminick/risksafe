...
if(isset($_REQUEST['response']) && $_REQUEST['response'] == "success"){
	$msg = "Bussiness Impact Analysis saved successfully.";	
}
...
<div class="row">
  ...
  <div class="col-lg-9 col-md-12">
    <h1 class="page-header">Business Impact Analysis</h1>
    ...
    <div class="panel panel-default">
      <div class="panel-body">
          <div class="clearfix mb20">
          	<button type="button" class="btn btn-md btn-info pull-right" id="btn_add">+ New Bussiness Impact Analysis</button>
          </div>
...
$(document).ready(function(e) {
   ...
   var table = $('#table').dataTable( {
        ...
        "ajax": "../controller/bia.php?action=list"
    } );

  $("#btn_add").click(function(e) {
	  $(location).attr("href","../view/bia.php?action=add");
  });
...
function del(id) {
	BootstrapDialog.show({		
		message: 'Are you sure you want to delete this Bussiness Impact Analysis?',
		...
		buttons: [{
			...
			action: function(dialogItself){
				//kod za booking
				res = $.ajax({type: "GET", url: "../controller/bia.php?action=delete&id="+id, async: false})	
