            ...
            <div class="col-lg-6 col-12 fnhsgr8">            	
                <div class="login-panel panel panel-default">
                    <div class="panel-heading custom">
                        <h3 class="panel-title fu49zk">RiskSafe - Log in</h3>
                    </div>
                        ...
                        <form role="form" method="post" action="../controller/users.php?action=login">
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Your RiskSafe E-mail Address..." name="email" id="username" type="email" required >
                                </div>
                                <div class="form-group">
                                    <label>Password:</label>
                                    <div class="fneip">
                                        <input class="form-control" placeholder="Your RiskSafe Password..." name="password" id="password" type="password" required>
                                        <button type="button" class="fyeviu"><i class="fa fa-eye"></i></button>
                                    </div>
                                </div>
                                <div style="text-align: center;display:flex">
                                    <button type="submit" class="btn btn-md btn-primary" id="btn_login"><i class="fa fa-sign-in"></i> Login</button>
                                    <a href="register.php" class="btn btn-md btn-warning" id="a_signup"><button type="button" id="btn_signup">Sign up</button></a>
                                </div>                              
                            </fieldset>
                        </form>
                    ...
                    <div class="panel-footer custom" style="text-align: center;">
						<a href="resetpassword.php" class="bb">Forgot my password ?</a>
                    </div>
                </div>                
