 ...
 * @author Brent R. Matzelle (original founder)
 */
include_once dirname(__FILE__) . '/../Classes/vendor/phpmailer/phpmailer/src/SMTP.php';
include_once dirname(__FILE__) . '/../Classes/vendor/phpmailer/phpmailer/src/Exception.php';
