<?php
    ...
    if (isset($_GET['module']) && isset($_GET['module']) !== "") {
        ...
        if(moduleExist($module_id, $con) === true){
            ...
            // include $file_dir.'error/404.php';
            // die();
...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" style='display:flex;gap:50px;'>
                                    ...
                                    <div>
                                        <input type='radio' id='saved' value='saved' name='control-type' <?php if($module_id === 'custom'){ echo 'checked'; } ?> />
    ...
    <style>
        ...
        textarea#compliance__requirements{
